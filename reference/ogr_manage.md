...
#> ℹ open dataset successful on DSN: "/tmp/Rtmp4SOHUr/test1.gpkg"
...
if (gdal_version_num() >= gdal_compute_version(3, 7, 0))
  ogrinfo(dsn, "layer2")
#> INFO: Open of `/tmp/Rtmp4SOHUr/test1.gpkg'
...
#> ℹ open dataset successful on DSN: "/tmp/Rtmp4SOHUr/mtbs_perims.shp"
