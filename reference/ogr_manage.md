...
#> ℹ open dataset successful on DSN: "/tmp/RtmpseiOhR/test1.gpkg"
...
if (gdal_version_num() >= gdal_compute_version(3, 7, 0))
  ogrinfo(dsn, "layer2")
#> INFO: Open of `/tmp/RtmpseiOhR/test1.gpkg'
...
#> ℹ open dataset successful on DSN: "/tmp/RtmpseiOhR/mtbs_perims.shp"
