...
#> ℹ open dataset successful on DSN: "/tmp/RtmpigJoRq/test1.gpkg"
...
if (gdal_version_num() >= gdal_compute_version(3, 7, 0))
  ogrinfo(dsn, "layer2")
#> INFO: Open of `/tmp/RtmpigJoRq/test1.gpkg'
...
#> ℹ open dataset successful on DSN: "/tmp/RtmpigJoRq/mtbs_perims.shp"
