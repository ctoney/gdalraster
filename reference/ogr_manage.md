...
#> ℹ open dataset successful on DSN: "/tmp/RtmpBXu7oY/test1.gpkg"
...
if (gdal_version_num() >= gdal_compute_version(3, 7, 0))
  ogrinfo(dsn, "layer2")
#> INFO: Open of `/tmp/RtmpBXu7oY/test1.gpkg'
...
#> ℹ open dataset successful on DSN: "/tmp/RtmpBXu7oY/mtbs_perims.shp"
