...
#> ℹ output written to: "/tmp/RtmpJ5LQ7l/rastcalc21627329f0d9.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calce2162f6fdde4"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calce2162f6fdde4"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/RtmpJ5LQ7l/storml_lndscp.tif"
