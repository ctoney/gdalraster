...
#> ℹ output written to: "/tmp/RtmpwdLZAm/rastcalc1fba230154ba.tif"
...
(ndvi <- calc(expr, list(b4, b5), var.names = c("B4", "B5"), fmt = "MEM",
              ...
              return_obj = TRUE))
#> ℹ output written to: "calc1fba19921025"
#> C++ object of class <GDALRaster>
#>   • Driver: In Memory Raster (MEM)
#>   • DSN: "calc1fba19921025"
...
calc(expr = expr,
     ...
     out_band = 4,
     write_mode = "update")
#> ℹ output written to: "/tmp/RtmpwdLZAm/storml_lndscp.tif"
