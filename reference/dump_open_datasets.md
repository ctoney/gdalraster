...
dump_open_datasets()
#> Open GDAL Datasets:
#>   1 S GTiff  400259072 143x107x1 /home/runner/work/_temp/Library/gdalraster/extdata/storml_elev.tif
#> [1] 1
ds2 <- new(GDALRaster, elev_file)
dump_open_datasets()
#> Open GDAL Datasets:
#>   2 S GTiff  400259072 143x107x1 /home/runner/work/_temp/Library/gdalraster/extdata/storml_elev.tif
#> [1] 1
