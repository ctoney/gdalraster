...
* spatial reference systems and coordinate transformation (PROJ via GDAL headers)
* [geometry API](https://firelab.github.io/gdalraster/reference/index.html#geometry) operating on raw vectors of WKB or WKT strings (GEOS via GDAL headers)
