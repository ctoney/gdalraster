...
GDALVector create_ogr(const std::string &format,
                      ...
                      const std::string &layer, const std::string &geom_type,
                      const std::string &srs, const std::string &fld_name,
...
GDALVector ogr_layer_create(const std::string &dsn, const std::string &layer,
                            Rcpp::Nullable<Rcpp::List> layer_defn,
