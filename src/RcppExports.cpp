...
// create_ogr
GDALVector create_ogr(const std::string& format, const std::string& dst_filename, int xsize, int ysize, int nbands, const std::string& dataType, const std::string& layer, const std::string& geom_type, const std::string& srs, const std::string& fld_name, const std::string& fld_type, Rcpp::Nullable<Rcpp::CharacterVector> dsco, Rcpp::Nullable<Rcpp::CharacterVector> lco, Rcpp::Nullable<Rcpp::List> layer_defn);
...
// ogr_layer_create
GDALVector ogr_layer_create(const std::string& dsn, const std::string& layer, Rcpp::Nullable<Rcpp::List> layer_defn, const std::string& geom_type, const std::string& srs, Rcpp::Nullable<Rcpp::CharacterVector> options);
