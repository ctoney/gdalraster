...
test_that("identifyDriver works", {
    ...
    skip_if((nrow(gdal_formats("PostgreSQL")) == 0 && is.na(gdal_formats("PostgreSQL")$short_name)) ||
            (nrow(gdal_formats("PostGISRaster")) == 0 && is.na(gdal_formats("PostGISRaster")$short_name)))
